...
Deno-Client für [ErrorBrain](https://github.com/afeldman/errorbrain) - AI-powered debugging memory that captures, analyzes, and documents errors automatically.
...
- ✅ **Spec-driven** - types generated from canonical spec/
...
```typescript
import { ErrorBrainClient } from "https://raw.githubusercontent.com/afeldman/errorbrain/main/sdk/deno/src/mod.ts";
```
...
- `options.language` (optional): Language (default: 'deno')
...
See [spec/error_event.schema.json](../../spec/error_event.schema.json) for the canonical definition.
