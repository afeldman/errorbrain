...
TypeScript/JavaScript client for [ErrorBrain](https://github.com/afeldman/errorbrain) - AI-powered debugging memory that captures, analyzes, and documents errors automatically.
...
```bash
# Using npm
npm install @errorbrain/sdk-typescript

# Using yarn
yarn add @errorbrain/sdk-typescript

# Using pnpm
pnpm add @errorbrain/sdk-typescript
```
...
```javascript
const { ErrorBrainClient } = require('@errorbrain/sdk-typescript');
